...
function longestSentence(text) {
  ...
  const count = longestWord ? wordCount(longestWord) : 0;
...
function findLongestWord(sentences) {
  return sentences.reduce((longest, currentSentence) =>
  wordCount(currentSentence) > wordCount(longest) ? currentSentence : longest,
  sentences[0]
) || '';
}
